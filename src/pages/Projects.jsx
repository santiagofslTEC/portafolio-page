...
const Projects = () => {
  ...
  useEffect(() => {
    ...
    const tubes = [
      ...
      createTube(0x00aaff, tube3Variants, 8000, 0.7, 30000),
    ];
    ...
    const animate = () => {
      ...
      tubes.forEach((tube) => {
        const { points, progress, speeds, radialOffsets, baseColor, drifts } =
          tube;
        ...
        if (!tube.isLerping && now - tube.lastSwitch > switchDelay) {
          ...
          const nextIndex =
            (tube.currentIndex +
              1 +
              Math.floor(Math.random() * (tube.variants.length - 1))) %
            tube.variants.length;
            ...
            <div className="card-inner">
              <div className="card-front">
                ...
                <p className="project-desc">
                  A functional calculator built from scratch with vanilla
                  JavaScript, HTML, and CSS. Features regex input validation,
                  operation history, and a clean two-panel UI.
                </p>
          ...
          <div className="project-card">
            <div className="card-inner">
              <div className="card-front">
                ...
                <h3 className="project-name">Pokemon Nintendo Console</h3>
                <p className="project-desc">
                  A Nintendo Switch-inspired UI built with React and PokéAPI.
                  Browse Pokémon, navigate with a D-pad, and battle against the
                  computer in a turn-based VS screen.
                </p>
                <div className="project-tags">
                  <span className="tag">React</span>
                  <span className="tag">PokeAPI</span>
              ...
              <div className="card-back">
                <img
                  src="/Console-retro-game.png"
                  alt="Pokemon Console preview"
                  className="card-preview-img"
                />
                <div style={{ display: "flex", gap: "12px" }}>
                  <a
                    href="https://santiagofsltec.github.io/console-retro-game/"
                    target="_blank"
                    rel="noreferrer"
                    className="card-github-link"
                  >
                  ...
                  <a
                    href="https://github.com/santiagofslTEC/console-retro-game"
                    target="_blank"
                    rel="noreferrer"
                    className="card-github-link"
